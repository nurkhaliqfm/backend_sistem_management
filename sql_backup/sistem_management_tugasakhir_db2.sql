...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2023 at 06:09 PM
...
(1, 1, 206, 1, 'Fernand', '12345678', '2023', 'Aktif', 'Dr. Smith|JohnDoe S.Pd., M.Pd ', 'Dr. Jane|Heril ST', 'Analisis Data Menggunakan Algoritma XYZ', 'https://example.com/profile/johndoe.jpg', '2023-09-22 03:35:21', '2023-09-22 03:35:21');
...
(1, 1, 'Analisis Dampak Lingkungan Pabrik Y', 'Dr.Vonzy', 'Dr.Zize', 'assets\\1695397862202-dummies10.pdf', 'rejected', '2023-09-22 14:47:36', '2023-09-22 15:51:02');
...
(1, 'admin', '$2b$10$RUkhwEK8l2UQkucy8PTNvOrkS/VohjnGA8sMGiD/oDHoaP3n0i68y', 'admin', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwidXNlcm5hbWUiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTY5NTM1MjYyOCwiZXhwIjoxNjk1NDM5MDI4fQ.Ju5KJYgbgiT_6cO5MEUfeb7p1k9zddq0CNT2DKYHdkI', NULL, '2023-09-22 03:17:04', '2023-09-22 03:17:08');
...
--
ALTER TABLE `mahasiswa`
  ADD CONSTRAINT `asdasdas` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
